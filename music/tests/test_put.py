...
class TestUpdateArtistModel(APITestCase):
    ...
    def test_update_artist_instance(self):
        ...
        request = self.client.put('/artist/', {'first_name': 'John1', 'last_name':'Lawrence', 'birthday':'1999-11-11', 'age':'06:00:00'}, format='json')
...
class TestUpdateAlbumModel(APITestCase):
    ...
    def test_update_setView_album_instance(self):
        ...
        request = self.client.put('/album/', {'album_name': 'Chilling', 'artist':'John1 Lawrence', 'date_released':'2020-11-11', 'style':'Jazz'}, format='json')
        self.assertEqual(request.status_code, status.HTTP_200_OK)
...
class TestUpdateSongModel(APITestCase):
    ...
    def test_update_setView_song_instance(self):
        ...
        request = self.client.put('/song-list/', {'artist':{'first_name': 'John1', 'last_name':'Lawrence', 'birthday':'1999-11-11', 'age':'06:00:00'},
